                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-lg-6 col-md-10">
                        <div className="about-tile-gallery">
                            ...
                            <img src={"../../assets/img/tile-gallery/dc-new-logo.png"} alt="icon" className="icon" />
                            <img src={"../../assets/img/tile-gallery/icon-a.png"} alt="icon" className="zero-icon" />
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-10">
                        <div className="about-text pl-25">
                            <div className="section-title mb-40 left-border">
                                ...
                                <h2>APP HELPS EDUCATION ELEVATE THEIR VALUE.</h2>
                            </div>
                            <p>
